...
public class OurSolverTest {
    private static final int MAX_DEPTH = 30;
    //For this test, I will lower the MAX_DEPTH value to 30, since the naive solver is using recursion for its algorithm,
    //which will cause a stack overflow error if the MAX_DEPTH is too high.
